package com.dunwoo.tomcat.container.core;
...
import com.dunwoo.tomcat.container.Valve;
import com.dunwoo.tomcat.container.servletx.Request;
import com.dunwoo.tomcat.container.servletx.Response;
import com.dunwoo.tomcat.util.Escape;
...
public class ErrorReportValve extends Valve {
    ...
    protected String getPartialServletStackTrace(Throwable t) {
        ...
        for (int i = elements.length - 1; i >= 0; i--) { // 找到容器内部堆栈开始位置
            if ((elements[i].getClassName().startsWith("com.dunwoo.tomcat.container.servletx.AppFilterChain"))
        ...
        for (int i = 0; i < pos; i++) { // 排除容器内部堆栈信息
            if (!(elements[i].getClassName().startsWith("com.dunwoo.tomcat.container."))) {
