package com.dunwoo.tomcat.util;
...
import com.dunwoo.tomcat.util.digester.Digester;
...
public class TestDigester {
    ...
    public void setUp() {
        ...
        // 初始化解析规则
        digester.addObjectCreate("employee", "com.dunwoo.tomcat.util.Employee");
        ...
        digester.addObjectCreate("employee/address", "com.dunwoo.tomcat.util.Address");
