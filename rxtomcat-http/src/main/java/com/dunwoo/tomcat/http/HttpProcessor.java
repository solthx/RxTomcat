...
import com.dunwoo.tomcat.http.codecs.ChunkedCodec;
import com.dunwoo.tomcat.http.codecs.IdentityCodec;
import com.dunwoo.tomcat.net.NioChannel;
import com.dunwoo.tomcat.net.Processor;
import com.dunwoo.tomcat.net.Handler.SocketState;
/**
 * HTTP 协议处理器，与底层通道通信
 * 
 * @author wskwbog
